export default {
  ...
  // Auth
  auth: {
    brandEyebrow: 'LLM PROVIDER · AI API PLATFORM',
    ...
    brandRoute: 'LLM Provider selects an available upstream',
    ...
    secureAccess: 'Secure access to LLM Provider',
    backHome: 'Back to home',
    welcomeBack: 'Sign in to LLM Provider',
    signInToAccount: 'Enter your AI API service platform',
    signIn: 'Sign In',
    ...
    createAccount: 'Join LLM Provider',
    signUpToStart: 'Create your account and start using one unified AI API',
    signUp: 'Sign up',
    processing: 'Processing...',
    continue: 'Continue',

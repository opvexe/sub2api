      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-gray-100 p-2 dark:bg-dark-700">
                <Icon name="server" size="md" class="text-gray-600 dark:text-gray-300" :stroke-width="2" />
              </div>
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-gray-100 p-2 dark:bg-dark-700">
                <Icon name="bolt" size="md" class="text-gray-600 dark:text-gray-300" :stroke-width="2" />
              </div>
              <div class="flex-1">
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">

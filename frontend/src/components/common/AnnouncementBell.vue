      ...
      <Transition name="modal-fade">
        ...
        >
          ...
          >
            ...
            <div class="relative overflow-hidden border-b border-gray-100/80 bg-gradient-to-br from-gray-50 to-gray-100/40 px-6 py-5 dark:border-dark-700/50 dark:from-dark-900/40 dark:to-dark-900/20">
              <div class="relative z-10 flex items-start justify-between">
                ...
                <div class="flex items-center gap-2">
                  <button
                    ...
                    @click="markAllAsRead"
                    :disabled="loading"
                    class="rounded-lg bg-primary-600 px-4 py-2 text-xs font-medium text-white shadow-lg shadow-primary-500/30 transition-all hover:bg-primary-700 hover:shadow-xl disabled:opacity-50 dark:bg-primary-600 dark:hover:bg-primary-700"
                  >
              ...
              <!-- Decorative gradient -->
              <div class="absolute right-0 top-0 h-full w-48 bg-gradient-to-l from-gray-100/40 to-transparent dark:from-dark-900/20"></div>
            </div>
            ...
            <div class="max-h-[65vh] overflow-y-auto">
              ...
              <div v-else-if="announcements.length > 0">
                <div
                  ...
                  :class="{ 'bg-primary-50 dark:bg-primary-900/10': !item.read_at }"
      ...
      <Transition name="modal-fade">
        ...
        >
          ...
          >
            ...
            <div class="relative overflow-hidden border-b border-gray-100 bg-gradient-to-br from-gray-50 via-gray-100/50 to-gray-50/30 px-8 py-6 dark:border-dark-700 dark:from-dark-900/40 dark:via-dark-900/20 dark:to-dark-900/10">
              <!-- Decorative background elements -->
              <div class="absolute right-0 top-0 h-full w-64 bg-gradient-to-l from-gray-100/40 to-transparent dark:from-dark-900/30"></div>
              ...
              <div class="absolute -left-4 -bottom-4 h-24 w-24 rounded-full bg-gradient-to-tr from-primary-300/20 to-primary-400/20 blur-2xl"></div>
                  ...
                  <div class="mb-3 flex items-center gap-2">
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <span
                        ...
                        class="inline-flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-primary-600 to-primary-700 px-2.5 py-1 text-xs font-medium text-white shadow-lg shadow-primary-500/30"
                      >
            ...
            <div class="max-h-[60vh] overflow-y-auto bg-white px-8 py-8 dark:bg-dark-800">
              ...
              <div class="relative">
                ...
                <div class="absolute left-0 top-0 bottom-0 w-1 rounded-full bg-gradient-to-b from-primary-400 via-primary-500 to-primary-600"></div>
              ...
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <button
                    ...
                    class="rounded-xl bg-gradient-to-r from-primary-600 to-primary-700 px-5 py-2.5 text-sm font-medium text-white shadow-lg shadow-primary-500/30 transition-all hover:shadow-xl hover:scale-105"
                  >
...
.dark .overflow-y-auto::-webkit-scrollbar-thumb:hover {
  background: linear-gradient(to bottom, theme('colors.dark.500'), theme('colors.dark.600'));
}
</style>

      ...
      <div v-else class="space-y-6">
        ...
        <div v-if="exclusiveGroups.length > 0">
          <div class="mb-3 flex items-center gap-2">
            <div class="h-1.5 w-1.5 rounded-full bg-gray-400 dark:bg-dark-400"></div>
              ...
              <div class="flex items-center gap-4">
                ...
                <div class="min-w-0 flex-1">
                  <div class="flex items-center gap-2">
                    ...
                    <span class="inline-flex items-center rounded-full bg-gray-200 px-2 py-0.5 text-xs font-medium text-gray-700 dark:bg-dark-700 dark:text-gray-300">

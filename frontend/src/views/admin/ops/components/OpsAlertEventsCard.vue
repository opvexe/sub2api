...
function severityBadgeClass(severity: string | undefined): string {
  ...
  if (s === 'p2' || s === 'info') return 'bg-gray-200 text-gray-800 dark:bg-dark-600 dark:text-gray-200'
...
function statusBadgeClass(status: string | undefined): string {
  ...
  if (s === 'manual_resolved') return 'bg-gray-100 text-gray-700 ring-gray-600/20 dark:bg-dark-800 dark:text-gray-300 dark:ring-gray-500/30'

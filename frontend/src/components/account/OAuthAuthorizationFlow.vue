<template>
  ...
  >
      ...
      <div class="flex-1">
        <h4 class="mb-3 font-semibold text-gray-900 dark:text-gray-100">{{ oauthTitle }}</h4>
        ...
        <div v-if="inputMethod === 'refresh_token' || inputMethod === 'mobile_refresh_token'" class="space-y-4">
          <div
            class="rounded-lg border border-gray-200 bg-white/80 p-4 dark:border-dark-600 dark:bg-dark-800/80"
          >
            ...
            <div class="mb-4">
              ...
              >
                <Icon name="key" size="sm" class="text-gray-500 dark:text-gray-400" />
                Refresh Token
                <span
                  v-if="parsedRefreshTokenCount > 1"
                  class="rounded-full bg-gray-600 px-2 py-0.5 text-xs text-white dark:bg-dark-600"
                >
          ...
          >
            ...
            <div class="mb-4">
              <label
                class="mb-2 flex items-center gap-2 text-sm font-semibold text-gray-700 dark:text-gray-300"
              >
                <Icon name="user" size="sm" class="text-gray-500 dark:text-gray-400" />
        ...
        <div v-if="inputMethod === 'manual'" class="space-y-4">
          ...
          >
            <div class="flex items-start gap-3">
              <div
                class="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-gray-700 text-xs font-bold text-white dark:bg-dark-600"
              >
                1
              </div>
              <div class="flex-1">
                ...
                <div v-if="showProjectId && platform === 'gemini'" class="mb-3">
                  <label class="input-label flex items-center gap-2">
                    ...
                    <a
                      ...
                      class="inline-flex items-center gap-1 text-xs font-normal text-primary-600 hover:text-primary-700 dark:text-primary-400"
                    >
              ...
              <div class="flex-1">
                ...
                <div>
                  <label class="input-label">
                    <Icon name="key" size="sm" class="mr-1 inline text-gray-500 dark:text-gray-400" />
                    {{ oauthAuthCode }}
                  </label>
                  <textarea

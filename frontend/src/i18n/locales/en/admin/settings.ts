export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for OriginCoder end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for OriginCoder end-user login',
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDescription: 'When an account\'s current native usage window (OpenAI Codex/Anthropic session, or Grok request/token utilization) reaches this percent, OriginCoder temporarily removes it from scheduling until the window resets. Use 100 to disable.',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve rates declared by upstream OriginCoder sites. Account rates change only when the separate sync switch is enabled.',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'OriginCoder',
      ...
      payment: {
        ...
        field_payCurrency: 'Pay currency and network',
        ...
        field_nowpaymentsIpnSecretHint: "The IPN secret from NOWPayments → Settings → Payments → IPN, used to verify callback signatures. You must also set the IPN callback URL in the NOWPayments dashboard to this site's /api/v1/payment/webhook/nowpayments, otherwise orders stay pending forever.",
        field_nowpaymentsPayCurrencyHint: "Coin and network the customer actually sends. Choosing the wrong network makes the customer's funds unrecoverable — keep it aligned with what you have enabled in NOWPayments.",
        field_nowpaymentsApiBaseHint: "Leave blank to use the official endpoint https://api.nowpayments.io/v1. Only change it when proxying through your own gateway.",
        field_paymentCurrencyHint: "Defaults to CNY. Stripe, Airwallex and NOWPayments support selecting HKD, USD and other currencies where the account allows it; WeChat Pay, Alipay and EasyPay remain CNY. NOWPayments prices in this currency and converts it to the on-chain amount at the live rate.",
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on OriginCoder orders; the upstream type is sent as EasyPay type.',
        ...
        nowpaymentsWebhookHint: "Paste this URL into NOWPayments → Settings → Payments → IPN callback URL. Without it, orders never complete after the customer pays.",
        nowpaymentsGuideSummary: "Generate the API key and IPN secret in the NOWPayments dashboard under Settings. The IPN secret verifies callback signatures — if it is missing or wrong, every payment notification is rejected.",
        nowpaymentsGuideNote: "The pay currency determines which chain the customer sends on. Do not change it while orders are in flight — addresses already issued belong to the old chain and reconciliation will fail. On-chain transfers are irreversible; this provider does not support programmatic refunds.",
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'OriginCoder',
        useTls: 'Use TLS',

export default {
  ...
  auth: {
    ...
    brandRoute: 'LLM Provider 智能选择可用上游',
    multiFormatCompatible: '兼容三种主流格式',
    openaiFormat: 'OpenAI 格式',
    claudeFormat: 'Claude 格式',
    geminiFormat: 'Gemini 格式',
    secureAccess: '安全访问 LLM Provider',
    backHome: '返回首页',
    welcomeBack: '登录 LLM Provider',
    signInToAccount: '进入您的 AI API 服务平台',
    signIn: '登录',
    signingIn: '登录中...',
    ...
    createAccount: '注册 LLM Provider',
    signUpToStart: '创建账户，开始使用统一 AI API 服务',
    signUp: '注册',
    processing: '处理中...',
    continue: '继续',
    rememberMe: '记住我',

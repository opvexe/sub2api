    ...
    <form id="refund-form" @submit.prevent="handleSubmit" class="space-y-4">
      ...
      >
        ...
        <div v-if="order?.refund_requested_at" class="mt-2 flex justify-between text-sm">
          <span class="text-primary-600 dark:text-primary-400">{{ t('payment.admin.refundRequestedAt') }}</span>
        ...
        <div v-if="order?.refund_request_reason" class="mt-1 text-sm">
          <span class="text-primary-600 dark:text-primary-400">{{ t('payment.admin.refundRequestReason') }}:</span>
      ...
      <div>
        ...
        <div
          ...
          class="mt-2 rounded-lg bg-gray-100 p-3 text-sm text-gray-700 dark:bg-dark-700 dark:text-gray-300"
        >

    ...
    >
      ...
      <div v-if="form.platform === 'anthropic'">
        ...
        <div
          ...
          class="mt-3 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-xs text-gray-700 dark:border-dark-600 dark:bg-dark-800 dark:text-gray-300"
        >
      ...
      <div v-if="form.platform === 'gemini'">
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            class="flex items-center gap-1 rounded px-2 py-1 text-xs text-primary-600 hover:bg-primary-50 dark:text-primary-400 dark:hover:bg-primary-900/20"
          >
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  <span
                    class="rounded bg-gray-200 px-2 py-0.5 text-[10px] font-semibold text-gray-700 dark:bg-dark-600 dark:text-gray-200"
                  >
